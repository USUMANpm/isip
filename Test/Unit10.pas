...
begin
  if RadioGroup2.ItemIndex = 1 then Inc(FAnswerCount); // правильный ответ - вторая строчка
  TabSheet3.Show;
end;

procedure TForm10.Button3Click(Sender: TObject);
begin
  if RadioGroup3.ItemIndex = 0 then Inc(FAnswerCount); // правильный ответ - вторая строчка
  TabSheet4.Show;
end;
...
begin
  if FTestOK then Form4.Show  // отбражаем следующую лекцию
             else Form1.Show; // возвращаемся к первой
